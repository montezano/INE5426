...
chamada_funcao_classe : IDENTIFICADOR PONTO IDENTIFICADOR E_PARENTESES (IDENTIFICADOR (VIRGULA IDENTIFICADOR)*)? D_PARENTESES PONTOVIRGULA;

chamada_funcao_servico : IDENTIFICADOR SETA IDENTIFICADOR E_PARENTESES (IDENTIFICADOR (VIRGULA IDENTIFICADOR)*)? D_PARENTESES PONTOVIRGULA;
